...
(time
 (def part-1-solutions (mapv solve-part-1 ["2020/day_20_small.txt" "2020/day_20_input.txt" "2020/day_20_test.txt"])))

(map first part-1-solutions)
;; => (110355024 15003787688423 20899048083289)
